...
- se baser sur les definitions typescript pour creer le context jsonld comme pour schema.org https://github.com/google/schema-dts, article du concepteur : https://dev.to/eyassh/modeling-schema-org-json-ld-in-typescript-a-story-in-four-parts-254k
...
# recupérer les type depuis typescript pour les convertir en jsonld context
- https://github.com/visjs/vis-network/issues/135
-> install https://www.npmjs.com/package/@types/vis

```
npm install --save @types/vis
npm -D i @types/vue @vue/cli-plugin-typescript @vue/eslint-config-typescript typescript // https://blog.engineering.publicissapient.fr/2020/06/10/booster-votre-app-vue-js-avec-typescript/
```
...
# Prototypage rapide d'application
- https://stackblitz.com/, https://stackblitz.com/edit/vue-url2wr
